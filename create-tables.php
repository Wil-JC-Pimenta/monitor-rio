...
try {
    ...
    // Inserir dados mock
    echo "🌱 Inserindo dados mock...\n";

    // Inserir estações
    $stations = [
        ['PIR001', 'Rio Piracicaba - Ipatinga', 'Rio Piracicaba - Ipatinga', -19.4708, -42.5369, 'Estação principal do Rio Piracicaba em Ipatinga'],
        ['PIR002', 'Rio Piracicaba - Timóteo', 'Rio Piracicaba - Timóteo', -19.5831, -42.6442, 'Estação do Rio Piracicaba em Timóteo'],
        ['PIR003', 'Rio Piracicaba - Coronel Fabriciano', 'Rio Piracicaba - Coronel Fabriciano', -19.5189, -42.6289, 'Estação do Rio Piracicaba em Coronel Fabriciano'],
    ];
